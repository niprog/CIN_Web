...
<?php if ($this->_rootref['PAGE'] == (1)) {  if ($this->_rootref['ERROR'] != ('')) {  ?>
	...
	<?php if ($this->_rootref['TQTY'] > (1)) {  ?>
				<tr bgcolor="#FFFEEE">
					...
					<td><input type="number" name="qty" id="qty" value="<?php echo (isset($this->_rootref['QTY'])) ? $this->_rootref['QTY'] : ''; ?>" min="1" max="<?php echo (isset($this->_rootref['TQTY'])) ? $this->_rootref['TQTY'] : ''; ?>" step="1"></td>
				</tr>
