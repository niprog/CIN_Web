...
-------------------------------------------------------------------------------*/
//------------------------------------------------------------------------------
function show_header($title, $list = false) {			// header for html-page
  echo "<table class=\"headerline\" summary=\"\" border=\"0\" width=\"100%\" cellspacing=\"0\" cellpadding=\"5\"><tbody>\n";
	echo "<tr><td style=\"width:10px;\"></td><td class=\"title\">";
