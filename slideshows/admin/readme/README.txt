...
This is a Component for Use with Joomla!
----------------------------------------------------------------------------------------------------
Installation:
	1. Download the latest version of joomlaXplorer from http://Joomla!forge.net/projects/joomlaXplorer/.
...
----------------------------------------------------------------------------------------------------
Users:
	* To enable user-authentication, set "require_login" to true in "_config/conf.php";
	  you should also set the path for the admin user in "_config/.htusers".
